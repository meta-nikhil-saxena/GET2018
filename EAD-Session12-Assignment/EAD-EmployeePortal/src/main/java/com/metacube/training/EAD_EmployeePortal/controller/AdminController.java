...
public class AdminController {
	...
	public String saveproject(@ModelAttribute("employee") Employee employee,
			...
			@RequestParam("jobs") int jobid,
			@RequestParam("reporting_manager") int managerid,
			@RequestParam("teamlead") int employeeTeamleadId,
		...
		if (employee != null && employee.getId() == 0) {
			...
			jobdetails.setProjectId(projectid);
			jobdetails.setReportingManager(managerid);
			jobdetails.setTeam_lead(employeeTeamleadId);
