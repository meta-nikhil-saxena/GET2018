...
import com.metacube.training.EAD_Session9EmployeePortal.services.EmployeeService;
import com.metacube.training.EAD_Session9EmployeePortal.services.JobService;
import com.metacube.training.EAD_Session9EmployeePortal.services.ProjectService;
import com.metacube.training.EAD_Session9EmployeePortal.services.SkillService;
...
public class AdminController {
	...
	public String saveproject(@ModelAttribute("employee") Employee employee) {
		if (employee != null && employee.getId() == 0) {
			String employeeId = "E18/"+employee.getFirstName()+"/"+employee.getLastname();
